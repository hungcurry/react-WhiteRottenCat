      ...
      <div className="bg-indigo-500 p-5 h-screen">
        <div className="max-w-[768px] m-auto bg-white p-5">
          ...
          <div className="flex">
            ...
            <button onClick={ handleAddTodo } className="w-[50px] h-[50px] border-0 bg-sky-500  rounded-r-lg text-white">+</button>
          </div>

          <List />

          <div className="flex justify-between items-center mt-5">
            <p><span className="font-medium">{ todoList.length }</span> 個事項待完成</p>
