...
const Hero = () => {
  ...
  // Generate story data
  useEffect(() => {
    const storyData = Array(6).fill().map((_, i) => ({
      id: i,
      name: '阿貓',
      title: '白爛貓',
  ...
  useEffect(() => {
    const liveData = Array(20).fill().map((_, i) => ({
      id: i,
        ...
        <div className="w-full max-w-[744px] mx-auto px-4 pb-28 lg:pb-10">
              ...
              <div className="flex-1 px-[4px] min-w-[120px] cursor-pointer">
                <div className="h-full flex flex-col">
                  ...
                  <div className="bg-fb-card pt-6 px-2 pb-2 relative">
                    <button className="w-[32px] h-[32px] p-2 absolute -top-7 left-[calc(50%-16px)] bg-fb rounded-full focus:outline-none ring-fb-card ring flex justify-center items-center">
          ...
          {!isLoading ? (
              ...
              <div key={post.id} className="card pb-0 px-0">
                ...
                <div className="px-4">
                  <div className="border-b border-gray-700 flex justify-between py-3">
                    ...
                    <div className="flex items-center">
                      <p className="text-xl text-gray-400 mr-2">{post.comments}則留言</p>
                      <p className="text-xl text-gray-400">{post.shares}次分享</p>
                    </div>
                  </div>
            ...
            Array(3).fill().map((_, i) => (
              <div key={i} className="card pb-0 px-0 animate-pulse">
